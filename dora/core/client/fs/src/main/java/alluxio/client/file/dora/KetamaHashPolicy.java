...
public class KetamaHashPolicy implements WorkerLocationPolicy {
  private final KetamaHashProvider HASH_PROVIDER;
  /**
   ...
   */
  public KetamaHashPolicy(int replicas) {
    HASH_PROVIDER = new KetamaHashProvider(100, Constants.SECOND_MS, replicas);
  }
